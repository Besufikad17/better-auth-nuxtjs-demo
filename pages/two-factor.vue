...
<template>
    <div class="flex items-center justify-center min-h-[calc(100vh-62px)] dark:bg-black bg-white overflow-auto w-full">
        ...
        <div class="flex flex-col items-center p-8 w-full">
            <div
                class="flex flex-col gap-4 p-4 border bg-white dark:bg-black border-gray-300 dark:border-primary-700 w-1/2 lg:w-1/3">
                ...
                <OTPField v-model="otp"
                    class="p-2 focus:border-2 focus:border-gray-950 dark:bg-[#424242] dark:text-white" :fields="6" />
                <button
                ...
                <span
                    class="flex items-center justify-center bg-transparent focus:outline-none focus:ring-0 dark:text-primary-700 hover:underline cursor-pointer"
                    @click="resend">Resend OTP</span>
            </div>
        </div>
    </div>
</template>
