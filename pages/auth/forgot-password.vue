    ...
    <div class="flex items-center justify-center min-h-[calc(100vh-62px)] dark:bg-black bg-white overflow-auto">
        ...
        <div class="flex flex-col p-8">
            <div class="flex flex-col gap-4 p-4 border bg-white dark:bg-black border-gray-300 dark:border-primary-700">
                ...
                <div v-if="emailSent"
                    class="flex items-center gap-3 w-full p-3 border bg-white dark:bg-black border-gray-300 dark:border-primary-700 dark:text-white">
                ...
                <NuxtLink to="/auth/forgot-password" v-if="emailSent"
                ...
                <button v-else
                    ...
                    :class="isLoading ? 'bg-gray-800 dark:bg-gray-300' : 'bg-black dark:bg-white'" :disabled="isLoading"
                    @click="() => forgetPassword()">
                    Send reset link
                    <Icon v-if="isLoading" name="svg-spinners:90-ring-with-bg" />
                </button>
                <NuxtLink v-if="!emailSent" to="/auth/sign-in"
                    class="flex items-center justify-center dark:text-gray-100 hover:underline p-2">Back to sign in
                </NuxtLink>
            </div>
        </div>
    </div>
